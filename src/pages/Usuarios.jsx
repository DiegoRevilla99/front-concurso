...
export const Usuarios = () => {
	return (
		<div class="row py-5 px-4 cuerpo">
			{" "}
				...
				<div class="bg-white shadow rounded overflow-hidden">
					...
					<div class="px-4 pt-0 pb-4 cover">
						...
						<div class="media align-items-end profile-head">
							...
							<a href="#" class="btn btn-outline-light btn-sm btn-block">
								Edit profile
							</a>
					...
					<div class="px-4 py-3">
						{" "}
						<h5 class="mb-0" style={{ textAlign: "left" }}>
							About
						</h5>{" "}
						<div class="p-4 rounded shadow-sm bg-light">
							{" "}
							<p class="font-italic mb-0" style={{ textAlign: "left" }}>
								Web Developer
							</p>{" "}
							<p class="font-italic mb-0" style={{ textAlign: "left" }}>
								Lives in New York
					...
					<div class="px-4 py-3">
						{" "}
						<h5 class="mb-0" style={{ textAlign: "right" }}>
							Contact
						</h5>{" "}
						<div class="p-4 rounded shadow-sm bg-light">
							{" "}
							<p class="font-italic mb-0" style={{ textAlign: "right" }}>
								Phone: 555555555
							</p>{" "}
							<p class="font-italic mb-0" style={{ textAlign: "right" }}>
								Direction: Nathan Avenue #302
							</p>{" "}
							<p class="font-italic mb-0" style={{ textAlign: "right" }}>
								Description: An iconic profile :V
							</p>{" "}
						</div>{" "}
					</div>{" "}
					<div class="py-4 px-4">
